...
for (cell in clusters) {
        ...
        list.go.BP.all[[as.character(cell)]] <- simplify(egmt)@result
...
GO.cell <- c('IC', 'IC', 'IC', 'EC', 'EC', 'PVC', 'PVC', 
             'SC1', 'SC1', 'SC1', 'SC2', 'SSC', 'SSC', 'SSC', 'SSC', 
             'CSC', 'CSC', 'CSC', 'CSC', 'TC', 'TC', 'TC', 'TC', 
             'Chondrocyte1', 'Chondrocyte1')
