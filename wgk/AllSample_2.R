...
marker.genes <- c('APOE', 'VCAN', 'COCH', 
                  'COL1A1', 'LUM', 'HES1', 'EGR1', 
                  'VIT', 'ELN', 'CYTL1', 'COL2A1', 'COL9A2', 'ACAN',
                  'ACTA2', 'PDGFRB', 'MCAM', 'CDH5', 'IL1B')
...
file.marker_2 <- paste0(path.data, 'marker_genes.Rdata')
