...
if __name__ == '__main__':
    path_raw = '/root/scATAC/ATAC_data/Alzheimer_Morabito/raw_data'
    file_meta = os.path.join(path_raw, 'GSE174367_snATAC-seq_cell_meta.csv')
    df_meta = pd.read_csv(file_meta)
    file_h5 = os.path.join(path_raw, 'GSE174367_snATAC-seq_filtered_peak_bc_matrix.h5')
    adata_raw = sc.read_10x_h5(file_h5)
