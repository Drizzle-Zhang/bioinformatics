...
df.ks.female.filter <- df.ks.female[
    df.ks.female$pvalue.control < 0.05 | df.ks.female$pvalue.treat < 0.05,]
df.ks.female.filter <- df.ks.female.filter[
    !(df.ks.female.filter$pathway 
    %in% c('ABC transporters', 'Vibrio cholerae pathogenic cycle',
         'Biosynthesis of siderophore group nonribosomal peptides',
         'Flagellar assembly', 'Valine, leucine and isoleucine biosynthesis',
         'Carbon fixation in photosynthetic organisms')),]
