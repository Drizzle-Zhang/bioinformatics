...
### flank cutoff
# DHS
df.flank.DHS <- read.delim('./DHS/flank_count_term.txt', 
...
# H3K4me3
df.flank.H3K4me3 <- read.delim('./H3K4me3/flank_count_term.txt', 
                           sep = '\t', stringsAsFactors = F)
...
# H3K27ac
df.flank.H3K27ac <- read.delim('./H3K27ac/flank_count_term.txt', 
                           sep = '\t', stringsAsFactors = F)
