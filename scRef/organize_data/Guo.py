    ...
    for sub_dir in dirs:
        ...
        for cluster in clusters:
            ...
            if pre_pattern.match(path_folder[0]):
                ...
                se_cluster.name = \
                    f"{path_folder[0]}|counts.txt|{cluster}|{cl_id[0]}"
                list_clusters.append(se_cluster)
...
if __name__ == '__main__':
    ...
    exp_raw(
        ...
        'HumanTestis_SingleCell_Guo2018/cell_exp.txt',
        '/home/zy/single_cell/data_human/L2/'
        'HumanTestis_SingleCell_Guo2018/cell_type.txt',
        '/home/zy/single_cell/data_human/L2/'
        'HumanTestis_SingleCell_Guo2018/SuppTable1_AllCellClusters.txt',
        '/home/zy/single_cell/data_human/L2/'
        'HumanTestis_SingleCell_Guo2018/cluster_celltype.txt',
        '/home/zy/single_cell/data_human/L2/'
        'HumanTestis_SingleCell_Guo2018/')
    sum_by_cl(
        '/home/zy/single_cell/data_human/L2/'
        'HumanTestis_SingleCell_Guo2018/')
