...
def exp_raw(file_counts, ref_file, file_meta, path_output):
    ...
    df_meta = pd.read_csv(file_meta, sep='\t', dtype='object')
    ...
    for cluster in df_ref['Cell_type']:
        sub_cells = np.array(
            df_meta.loc[df_meta['Cluster'] == cluster, 'ID']).tolist()
...
if __name__ == '__main__':
    ...
    exp_raw(
        ...
        'MouseSpermatogenesis_SingleCell_Ernst2019/raw_count/cell_exp.txt',
        '/home/disk/scRef/MouseReference_v1/'
        'MouseSpermatogenesis_SingleCell_Ernst2019/cell_type.txt',
        '/home/disk/scRef/MouseReference_v1/'
        'MouseSpermatogenesis_SingleCell_Ernst2019/raw_count/cell_meta.txt',
        '/home/disk/scRef/MouseReference_v1/'
        'MouseSpermatogenesis_SingleCell_Ernst2019/')
    sum_by_cl(
        '/home/disk/scRef/MouseReference_v1/'
        'MouseSpermatogenesis_SingleCell_Ernst2019/')
    time_end = time()
