...
vec.title <- rep(c('MCA -> Mouse Neocortex', 'MCA -> Mouse Duodenum', 
...
df.plot$dataset <- factor(df.plot$dataset, levels = c('MCA -> Mouse Neocortex', 'MCA -> Mouse Duodenum', 
...
df.plot$method <- factor(df.plot$method, levels = c('scMCA', 'scHCL', 'scMAGIC'))
