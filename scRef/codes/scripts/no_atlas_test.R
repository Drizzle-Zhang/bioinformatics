...
df.plot <- rbind(df.plot, data.frame(strategy = 'no atlas',
                                     data = '1st situation',
                                     Dataset = 'Muraro -> Segerstolpe, Human pancreas',
...
df.plot <- rbind(df.plot, data.frame(strategy = 'no atlas', data = '4th situation',
...
df.plot <- rbind(df.plot, data.frame(strategy = 'use atlas', data = '4th situation',
                                     Dataset = 'Han -> Ding, Human PBMC',
...
df.plot$label <- factor(df.plot$label, levels = rev(c('Muraro -> Baron, Human pancreas (1st situation)',
                                                  ...
                                                  'Han -> Campbell, Mouse brain (3rd situation)',
                                                  'Han -> Ding, Human PBMC (4th situation)')))
