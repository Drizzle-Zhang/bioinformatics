path.threeround <- '/mdshare/node9/zy/scRef/three_round/'
if (!file.exists(path.threeround)) {
    dir.create(path.threeround)
}

source('/local/zy/my_git/scRef/main/scRef.v23.R')
...
saveRDS(ref.labels, paste0(path.threeround, 'ref_labels_', ref.dataset, '.Rdata'))
saveRDS(label_sc, paste0(path.threeround, 'true_labels_', dataset, '.Rdata'))
...
result.scref <- SCREF(exp_sc_mat, ref.mtx, ref.labels,
                      ...
                      min_cell = 1, CPU = 10)
pred.scMAGIC.three <- result.scref$final.out$scRef.tag
table(label_sc, pred.scMAGIC.three)
rda.scMAGIC.three <- paste0(path.threeround, ref.dataset, '_', dataset, '_scMAGIC_three.Rdata')
saveRDS(pred.scMAGIC.three, file = rda.scMAGIC.three)
...
saveRDS(ref.labels, paste0(path.threeround, 'ref_labels_', ref.dataset, '.Rdata'))
saveRDS(label_sc[,2], paste0(path.threeround, 'true_labels_', dataset, '.Rdata'))
...
rda.scMAGIC.three <- paste0(path.threeround, ref.dataset, '_', dataset, '_scMAGIC_three.Rdata')
saveRDS(pred.scMAGIC.three, file = rda.scMAGIC.three)
table(label_sc[,2], pred.scMAGIC.three)
...
saveRDS(ref.labels, paste0(path.threeround, 'ref_labels_', ref.dataset, '.Rdata'))
saveRDS(label_sc$CellType, paste0(path.threeround, 'true_labels_', dataset, '.Rdata'))
...
rda.scMAGIC.three <- paste0(path.threeround, ref.dataset, '_', dataset, '_scMAGIC_three.Rdata')
saveRDS(pred.scMAGIC.three, file = rda.scMAGIC.three)
table(label_sc$CellType, pred.scMAGIC.three)
...
ref.labels <- readRDS(paste0(path.threeround, 'ref_labels_', ref.dataset, '.Rdata'))
true.labels <- readRDS(paste0(path.threeround, 'true_labels_', dataset, '.Rdata'))
...
# single
rda.scMAGIC.three <- paste0(path.threeround, ref.dataset, '_', dataset, '_scMAGIC_three.Rdata')
pred.scMAGIC.three <- readRDS(rda.scMAGIC.three)
res.single.1 <- simple.evaluation(true.labels, pred.scMAGIC.three, df.ref.names, df.sc.names)
df.plot <- rbind(df.plot, data.frame(strategy = 'three round',
                                     data = '1st situation',
...
rda.scMAGIC.three <- paste0(path.threeround, ref.dataset, '_', dataset, '_scMAGIC_three.Rdata')
pred.scMAGIC.three <- readRDS(rda.scMAGIC.three)
res.single.2 <- simple.evaluation(true.labels, pred.scMAGIC.three, df.ref.names, df.sc.names)
df.plot <- rbind(df.plot, data.frame(strategy = 'three round', data = '2nd situation',
...
rda.scMAGIC.three <- paste0(path.threeround, ref.dataset, '_', dataset, '_scMAGIC_three.Rdata')
pred.scMAGIC.three <- readRDS(rda.scMAGIC.three)
res.single.3 <- simple.evaluation(true.labels, pred.scMAGIC.three, df.ref.names, df.sc.names)
df.plot <- rbind(df.plot, data.frame(strategy = 'three round', data = '2nd situation',
...
rda.scMAGIC.three <- paste0(path.threeround, ref.dataset, '_', dataset, '_scMAGIC_three.Rdata')
pred.scMAGIC.three <- readRDS(rda.scMAGIC.three)
res.single.4 <- simple.evaluation(true.labels, pred.scMAGIC.three, df.ref.names, df.sc.names)
df.plot <- rbind(df.plot, data.frame(strategy = 'three round', data = '3rd situation',
...
write.table(df.plot, file = paste0(path.threeround, 'three_round.txt'), sep = '\t')
path.threeround <- '/mdshare/node9/zy/scRef/three_round/'
df.plot <- read.table(paste0(path.threeround, 'three_round.txt'), sep = '\t')
...
plot.bar <-
    ...
    scale_color_manual(breaks = c('three round', 'two round'),
                       values = c("#FFB6C1", "#BC80BD"),
                       labels = c(expression(paste("scMAGIC"['three-round'])),
                                  "scMAGIC")) +
    scale_fill_manual(breaks = c('three round', 'two round'),
                       values = c("#FFB6C1", "#BC80BD"),
                      labels = c(expression(paste("scMAGIC"['three-round'])),
                                 "scMAGIC")) + 
...
ggsave(filename = 'three_round.png',
       path = path.threeround, plot = plot.bar,
