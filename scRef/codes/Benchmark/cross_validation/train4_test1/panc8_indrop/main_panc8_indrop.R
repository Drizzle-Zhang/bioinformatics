...
setwd('/local/zy/my_git/scRef/Benchmark/cross_validation/train4_test1/panc8_indrop')
...
path.output <- '/mdshare/node9/zy/scRef/cross_validation/train4_test1/panc8_indrop/'
