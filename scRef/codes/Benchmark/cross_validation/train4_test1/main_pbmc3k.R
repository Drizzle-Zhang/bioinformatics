...
path.output <- '/home/zy/scRef/cross_validation/train4_test1/pbmc3k/'
...
# data("pbmc3k")
# OUT <- list()
# OUT$data.filter <- as.matrix(pbmc3k@assays$RNA@counts)
# OUT$label.filter <- data.frame(annotations = as.character(pbmc3k$seurat_annotations), 
