# setwd('/home/zy/my_git/scRef/Benchmark/cross_validation/train1_test4_delete_cell')
# source('./Cross_Validation.R')
# source('./method_functions.R')
# source('./evaluate.R')
# 
# path.input <- '/home/zy/scRef/'
# path.output <- '/home/zy/scRef/cross_validation/train1_test4_delete_cell/'

setwd('/home/drizzle_zhang/my_git/scRef/Benchmark/cross_validation/train1_test4_delete_cell')
source('./Cross_Validation.R')
source('./method_functions.R')
source('./evaluate.R')

path.input <- '/home/drizzle_zhang/scRef/'
path.output <- '/home/drizzle_zhang/scRef/cross_validation/train1_test4_delete_cell/'
