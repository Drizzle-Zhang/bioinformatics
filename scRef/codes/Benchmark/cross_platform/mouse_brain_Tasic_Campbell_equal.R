...
ref.labels <- label_Tasic$CellType
ref.mtx <- exp_Tasic
ref.dataset <- 'Tasic'
...
#                     del.label = c('miss', 'Ependymocytes', 'Fibroblast', 'MuralCells', 
#                                   'ParsTuber', 'Tanycyte'))
# saveRDS(OUT, file = paste0(path.output, dataset, '_equal.Rdata'))
OUT <- readRDS(paste0(path.output, dataset, '_equal.Rdata'))
